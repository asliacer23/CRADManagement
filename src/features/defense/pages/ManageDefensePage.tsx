...
export const ManageDefensePage: React.FC = () => {
  ...
  const { data: research } = useAllResearch();
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="bg-card border border-border rounded-xl p-5 space-y-4">
        ...
        <button onClick={handleSubmit} disabled={createDefense.isPending} className="w-full h-11 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2">
